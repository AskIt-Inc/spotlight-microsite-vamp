...
export const supportStaff: SupportStaff[] = [
  {
    ...
    name: 'Tracy Allen',
    credentials: 'RN',
    role: 'Hematology clinic nurse',
    note: 'Placeholder support-staff entry from the current VAMP planning material.',
  },
  {
    id: 2,
    name: 'Natalie Castillo',
    credentials: 'APRN',
    role: 'Cardiology specialist support',
    note: 'Final title, bio, and contact details still need VAMP approval.',
  },
  {
    id: 3,
    name: 'Brian Miller',
    credentials: 'RN',
    role: 'Cardiology nurse support',
    note: 'Final title, bio, and contact details still need VAMP approval.',
  },
  {
    id: 4,
    ...
    credentials: '',
    role: 'Hereditary amyloidosis support',
    note: 'Placeholder service line for the VAMP multidisciplinary-care model.',
  },
  {
    id: 5,
    name: 'Social Work & Patient Advocacy',
    credentials: '',
    role: 'Care navigation and support resources',
    note: 'Placeholder service line for quality-of-life and patient-support planning.',
  },
  {
    id: 6,
    name: 'Physical & Occupational Therapy',
    credentials: 'PT/OT',
    role: 'Mobility and daily-function rehabilitation',
    note: 'Placeholder service line for functional support and rehabilitation.',
  },
  {
    id: 7,
    name: 'Radiology & Pathology',
    credentials: '',
    role: 'Specialized diagnostics and disease monitoring',
    note: 'Placeholder diagnostic support area from the VAMP draft.',
  },
];
